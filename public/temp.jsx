...
function Projects() {
  ...
  const validateProject = () => {
    ...
    if (!newProject.projectPrevImage)
  ...
  async function handleRemoveProjectImage(publicId) {
    ...
    if (response.data.success) {
      setNewProject([...newProject,newProject.projectImage="",newProject.projectImageId=""])
    }
  }
              ...
              <div className="mt-2">
                ...
                {newProject.projectImage ? (
                  <div className="mt-4 flex flex-col items-start">
                    ...
                    <Button
                      type="button"
                      onClick={() => handleRemoveProjectImage(newProject.projectImageId)}

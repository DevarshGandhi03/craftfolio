...
export async function POST (request){
    ...
    try {
        const {portfolio_id,resumeTheme}= await request.json()
        ...
        portfolio_details.resumeTheme=resumeTheme;
        await portfolio_details.save()
    
        return apiResponse({message:"Resume theme updated!",success:true,statusCode:201});
